...
MODE = 2  # 1 denotes Train, 2 denotes Finetune and Test, 3 denotes Test all finetune from meta, 4 denotes Save Submodels, 5 denotes Load Submodels to Test
METHOD = 'EMNH'
SAVE_NUM = 150
