...
TASK_NUM = 3
N_WEIGHT = 105
AGG = 1  # Weight Aggregation, 1 denotes Weighted-Sum, 2 denotes Weighted-Tchebycheff, 3 denotes Penalty-based Boundary Intersection (PBI), 4 denotes Invert Penalty-based Boundary Intersection (IPBI)
TEST_DATASET_SIZE = 200
TRAIN_BATCH_SIZE = 64
TEST_BATCH_SIZE = 200
TESTAUG_BATCH_SIZE = 100
